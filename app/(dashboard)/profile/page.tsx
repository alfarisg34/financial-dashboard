  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6 sm:p-7 rounded-3xl border border-slate-800 relative overflow-hidden flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-slate-800">
              ...
              <div>
                <h2 className="text-base font-bold text-white">Informasi Profil</h2>
                <p className="text-xs text-slate-400">Ubah nama tampilan akun Anda</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled
                    value={email}
                    className="w-full bg-slate-950/40 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-xs text-slate-400 cursor-not-allowed select-none"
                  />
                </div>
                <p className="text-[10px] text-slate-500 mt-1">Email akun terikat pada otentikasi login</p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/80 border border-slate-700/70 rounded-xl py-2.5 pl-10 pr-4 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors"
                  />
                </div>
              </div>
            </form>
        ...
        <div className="glass-card p-6 sm:p-7 rounded-3xl border border-slate-800 relative overflow-hidden flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-slate-800">
              ...
              <div>
                <h2 className="text-base font-bold text-white">Ubah Password</h2>
                <p className="text-xs text-slate-400">Pastikan akun Anda tetap aman</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/80 border border-slate-700/70 rounded-xl py-2.5 pl-10 pr-10 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 transition-colors"
                  />
                  <button
                    type="button"
